...
#define BOOST_TEST_MODULE Riaspace Test Suite

#include "test_riaspace.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_riaspace_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
