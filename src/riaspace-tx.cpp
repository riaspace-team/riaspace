...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Riaspace Core riaspace-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  riaspace-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded riaspace transaction") + "\n" +
              "  riaspace-tx [options] -create [commands]   " + _("Create hex-encoded riaspace transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded riaspace transaction
