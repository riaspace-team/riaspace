 ...
 *
 *   // network
 *   CRiaspaceNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.riaspace.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CRiaspaceNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CRiaspaceNetwork(UniValue objIn)
    {
...
// // can be under: RiaspaceNetwork
// //   -- signature requirements : Key1(User)
// class CRiaspaceNetworkVariable : public CGovernanceObject
// {
// private:
