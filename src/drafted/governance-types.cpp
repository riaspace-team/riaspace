...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "RiaspaceNetwork") type = RiaspaceNetwork;
    if(strType == "RiaspaceNetworkVariable") type = RiaspaceNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == RiaspaceNetwork) s = "RiaspaceNetwork";
    if(type == RiaspaceNetworkVariable) s = "RiaspaceNetworkVariable";
