    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Riaspace Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Riaspace Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  riaspace-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Riaspace in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 RIA, 0.1 RIA, 1 RIA and 10 RIA -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://riaspacepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://riaspacepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Riaspace Core is shutting down...") + "<br /><br />" +
