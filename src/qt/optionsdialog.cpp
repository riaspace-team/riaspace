    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("RIA-riaspace"), QVariant("riaspace"));
    ui->theme->addItem(QString("RIA-light"), QVariant("light"));
    ui->theme->addItem(QString("RIA-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("RIA-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("RIA-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("RIA-traditional"), QVariant("trad"));
    ui->theme->hide();
    ui->themeLabel->hide();
