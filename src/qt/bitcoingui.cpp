    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Riaspace Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Riaspace address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and riaspace: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Riaspace Core"), this);
    aboutAction->setStatusTip(tr("Show information about Riaspace Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Riaspace Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Riaspace addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Riaspace addresses"));
    ...
    openAction->setStatusTip(tr("Open a riaspace: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Riaspace Core help message to get a list with possible Riaspace Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Riaspace Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Riaspace network", "", count));
    } else {
...
{
    QString strTitle = tr("Riaspace Core"); // default title
